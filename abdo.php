...
<head>
    ...
    <title>شاشة إدخال البيانات -   عبد الملك </title>
    <style>
        * {
        ...
        .card {
            ...
            border: 1px solid rgba(16, 201, 214, 0.08);
            border-radius: 16px;
            padding: 30px;
            width: 100%;
            max-width: 440px;
        ...
        button {
            background: linear-gradient(135deg, #d20d14, #e10d1b);
            color: #2f3640;
            padding: 12px;
            width: 100%;
            border: none;
...
<body>
    ...
    <header>
        ...
        <p>إعداد وتطوير المهندس: <strong>عبد الملك  </strong></p>
    </header>
    ...
    <footer>
        <p>&copy; 2026  جميع الحقوق محفوظة - تصميم وتطوير  عبد الملك  </p>
    </footer>
