    ...
    <style>
        * {
        ...
        .card {
            ...
            width: 100%;
            max-width: 440px;
            box-shadow: 0 15px 35px rgba(200, 14, 14, 0.5);
            transition: transform 0.3s ease;
        }

        .card:hover {
            transform: translateY(-5px);
            border-color: rgba(17, 242, 238, 0.3);
        }
        ...
        .card h2 {
            ...
            margin-bottom: 20px;
            border-bottom: 1px solid rgba(18, 205, 137, 0.08);
            padding-bottom: 12px;
        }
        ...
        input:focus, textarea:focus {
            outline: none;
            border-color: #fbc531;
            box-shadow: 0 0 10px rgba(22, 95, 211, 0.2);
        }

        button {
            background: linear-gradient(135deg, #16d539, #16a1e6);
            color: #2f3640;
            padding: 12px;
            width: 100%;
            border: none;
...
<body>
    ...
    <header>
        ...
        <p>إعداد وتطوير المهندس: <strong>محمد صادق الساده </strong></p>
    </header>
    ...
    <footer>
        <p>&copy; 2026 جميع الحقوق محفوظة - تصميم وتطوير محمد صادق الساده </p>
    </footer>
